...
@section('title', 'Full in CY | CargoTrack')

@section('content_header')
    <h1>CargoTrack - Depot - Full in CY</h1>
@stop
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Containers with Status: Full in CY</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="7" class="text-center">No containers with status Full in CY found</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
